...
const LeftSideBar = () => {
  ...
  return (
    <section className="background-light900_dark200 light-border max-sm:hidden lg:w-[266px] custom-scrollbar sticky left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300">
